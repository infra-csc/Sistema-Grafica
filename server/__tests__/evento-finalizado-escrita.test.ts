...
const SEM_GUARDA_POR_DESENHO: Record<string, string> = {
  ...
  "POST /api/admin/notificacoes/destinatarios": "administra a lista de destinatários dos avisos por e-mail; configuração do sistema, sem alvo de evento nenhum",
  "DELETE /api/admin/notificacoes/destinatarios/:id": "remove destinatário dos avisos por e-mail; configuração do sistema, sem alvo de evento nenhum",
