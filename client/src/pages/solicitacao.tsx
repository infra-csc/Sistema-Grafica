...
export default function Solicitacao() {
  ...
  // MOLDE (22/09) não tem arquivo final — libera só com o thumb (arquivoFinalOk).
  const semArquivoParaLiberar = !arquivoFinalOk(selectedItem) && !propostaDaFicha?.pulaProducao;
