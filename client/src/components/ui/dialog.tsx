...
>(({ className, children, onInteractOutside, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      // O toast vive num portal FORA do diálogo: fechar a notificação ("Arte
      // de #0381 aplicada") contava como clique fora e derrubava o modal
      // inteiro (dono, 21/09). Interagir com o toast nunca fecha o diálogo.
      onInteractOutside={(e) => {
        const alvo = e.target as Element | null;
        if (alvo?.closest?.("[data-toast-viewport]")) { e.preventDefault(); return; }
        onInteractOutside?.(e);
      }}
      className={cn(
