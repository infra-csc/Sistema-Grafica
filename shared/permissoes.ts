...
export const REGUA_DE_PAPEIS: RegraDeRota[] = [
  ...
  { metodo: "POST", rota: "/api/inventory", papeis: ["admin", "grafica"] },
  { metodo: "DELETE", rota: "/api/inventory/:id", papeis: ["admin"] },
  { metodo: "PATCH", rota: "/api/inventory/:id", papeis: ["admin", "grafica"] },
  { metodo: "PATCH", rota: "/api/inventory/:id/triage", papeis: ["admin", "grafica"] },
  { metodo: "POST", rota: "/api/inventory/:id/triage-split", papeis: ["admin", "grafica"] },
  ...
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id/atender", papeis: ["admin", "solicitacao"] },
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id/recusar", papeis: ["admin", "solicitacao"] },
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id/cancelar", papeis: ["admin", "atendimento"] },
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id", papeis: ["admin"] },
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id/ajuste", papeis: ["admin", "atendimento"] },
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id/ajuste/responder", papeis: ["admin", "solicitacao"] },
  { metodo: "PATCH", rota: "/api/pedidos-de-peca/:id/reabrir", papeis: ["admin", "atendimento", "solicitacao"] },
