...
export const REGUA_DE_PAPEIS: RegraDeRota[] = [
  ...
  // Guardas no formato `if (![...].includes(req.userRole))`, que a régua só
  // passou a ler em 22/09 — já existiam, apareciam como "qualquer logado".
  { metodo: "PATCH", rota: "/api/events/:id", papeis: ["admin", "solicitacao"] },
  { metodo: "PATCH", rota: "/api/events/:id/priority", papeis: ["admin", "atendimento", "solicitacao"] },
  { metodo: "PUT", rota: "/api/events/:id/quota-rules", papeis: ["admin", "atendimento"] },
  { metodo: "DELETE", rota: "/api/events/:id/quota-rules/:quota", papeis: ["admin", "atendimento"] },
  { metodo: "DELETE", rota: "/api/items/:id", papeis: ["admin", "solicitacao"] },
  { metodo: "POST", rota: "/api/items/:id/confer", papeis: ["admin", "grafica", "solicitacao"] },
  { metodo: "PATCH", rota: "/api/items/:id/deliver", papeis: ["admin", "grafica", "solicitacao"] },
  { metodo: "POST", rota: "/api/items/:id/initialize-sponsor-approvals", papeis: ["admin", "arte"] },
  { metodo: "POST", rota: "/api/sponsors", papeis: ["admin", "atendimento", "solicitacao"] },
  { metodo: "PATCH", rota: "/api/sponsors/:id", papeis: ["admin", "atendimento", "solicitacao"] },
  ...
  // "Excluir" virou arquivar: quem arquiva (admin) é quem restaura.
  { metodo: "POST", rota: "/api/events/:id/restaurar", papeis: ["admin"] },
  ...
  { metodo: "POST", rota: "/api/sponsors/:id/restaurar", papeis: ["admin"] },
