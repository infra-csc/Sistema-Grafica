...
export default function Arte() {
  ...
  const submitFinalFileMutation = useMutation({
    ...
    onSuccess: (_d, vars) => {
      ...
      resetFinalFileState();
      toast({
        title: vars.isUpdate ? "Arquivo atualizado" : "Arquivo final enviado",
        description: vars.isUpdate ? "Nova versão enviada — a Gráfica será avisada para rebaixar." : "O arquivo final foi enviado para revisão.",
      });
    },
    onError: (error: Error) => {
      toast({ title: "Erro ao enviar arquivo final", description: error.message, variant: "destructive" });
    },
  });
