...
export function BookHeranca({ bookUrl, capa, onCapaChange, paginas, onTogglePagina }: Props) {
  ...
  if (erro) {
    ...
    return (
      <p role="status" style={{ margin: 0, padding: "10px 12px", borderRadius: 8, fontSize: 13, color: TOM.alerta.text, backgroundColor: TOM.alerta.bg, border: `1px solid ${TOM.alerta.border}`, lineHeight: 1.5 }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }} data-testid="book-heranca">
      ...
      <label style={{ display: "inline-flex", alignItems: "center", gap: 8, minHeight: 36, fontSize: 13, fontWeight: 600, color: T.text, cursor: "pointer", alignSelf: "flex-start" }}>
      ...
      <p style={{ margin: 0, fontSize: 12, color: T.second, lineHeight: 1.5 }}>
      ...
      <p aria-live="polite" data-testid="heranca-resumo" style={{ margin: 0, fontSize: 12, fontWeight: 600, color: resumo ? T.text : T.second }}>
        {resumo ? `Entra no começo do book: ${resumo}.` : "Nada herdado — o book sai só com as grades geradas."}
      </p>
      {numPages === 0 ? (
        <p style={{ margin: 0, fontSize: 12.5, color: T.second, display: "inline-flex", alignItems: "center", gap: 6 }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  backgroundColor: marcada ? TOM.laranja.bg : "#fff",
                }}
              >
                {thumbs[n]
                ...
                <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 4, height: 22, fontSize: 11, fontWeight: 700, color: marcada ? T.accentText : T.second }}>
