...
const TYPE_CONFIG: Record<string, TypeCfg> = {
  ...
  item_packed:              { label: "Embalada",          filterLabel: "Embaladas (tubo ou sozinha)",      phase: "producao", icon: PackageCheck },
  item_unpacked:            { label: "Saiu da embalagem", filterLabel: "Saíram da embalagem",         phase: "producao", icon: Undo2 },
