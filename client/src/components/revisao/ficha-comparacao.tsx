...
export function FichaComparacao({ selectedItem, isMobile }: { selectedItem: PecaDaRevisao | null; isMobile: boolean }) {
  return (
    <>
      ...
      {/* ── 2 · COMPARAÇÃO — a única faixa que flexiona ──
          ...
          empurra os botões abaixo da dobra numa janela de 540px. No celular
